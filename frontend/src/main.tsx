  ...
  return (
    <main>
      ...
      <section id="overview" className="hero">
        ...
        <div className="notice"><span className="dot" /> In development · Baseline and sensor-disagreement runs are available through the CLI; web execution and chat are not available yet.</div>
      </section>
      <section aria-labelledby="foundation-title" className="foundation">
        ...
        <ol>
          ...
          <li><span>03</span><div><h3>Build toward evidence</h3><p>Baseline and sensor-disagreement runs produce repeatable telemetry and state events. More fault scenarios and investigations are planned.</p></div></li>
        </ol>
      </section>
