...
function App() {
  return (
    <main>
      <header><a href="#overview" className="brand">AEROTEST <span>COPILOT</span></a><span className="tag">Foundation / 01</span></header>
      <section id="overview" className="hero">
        ...
        <div className="notice"><span className="dot" /> In development · Simulation and chat are not available yet.</div>
      </section>
      <section aria-labelledby="foundation-title" className="foundation">
        <div><p className="eyebrow">THE FIRST CHECKPOINT</p><h2 id="foundation-title">A foundation we can test.</h2><p>Start with precise inputs and explicit boundaries. Add behavior only after the contracts agree.</p></div>
        <ol>
